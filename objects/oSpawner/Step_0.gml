...
switch (spwanLevel) {
	case 0:
		if instance_number(oOneDoller) < 3 SpawnItem(random_range(20,450),random_range(20,450),oOneDoller);
		if instance_number(oTwoDollers) < 3 SpawnItem(random_range(20,450),random_range(20,450),oTwoDollers);
		break;
	case 1:
		if instance_number(oOneDoller) < 2 SpawnItem(random_range(20,450),random_range(20,450),oOneDoller);
		if instance_number(oTwoDollers) < 3 SpawnItem(random_range(20,450),random_range(20,450),oTwoDollers);
	...
	case 2:
		...
		break;
	case 3:
		if instance_number(oFiveDollers) < 2 SpawnItem(random_range(20,450),random_range(20,450),oFiveDollers);
		if instance_number(oTenDollers) < 4 SpawnItem(random_range(20,450),random_range(20,450),oTenDollers);
		if instance_number(oBranch) < 3 SpawnItem(random_range(20,450),random_range(20,450),oBranch);
